...
//
//g++ -std=c++11 -I ./eigen3/ -I ./LBFGSpp-master/include -O2 main.cpp ReadDataFile.cpp IndepModel.cpp Models.cpp ModelStatistics.cpp BoltzmannLearning.cpp HeuristicAlgo.cpp BestBasis.cpp
//time ./a.out
//
#include <iostream>
#include <fstream>
...
list<Interaction> IndepModel(map<uint32_t, unsigned int> Nset, unsigned int N);
...
void All_Op_averages_Ising(map<uint32_t, unsigned int> Nset, double *P, double Z, unsigned int N, string outputfilename);
...
//*******************************************    // Nset[mu] = # of time state mu appears in the data set
  ...
  // ************************************************************************************************** //
  //filename = "SCOTUS_n9_N895_Ordered";
